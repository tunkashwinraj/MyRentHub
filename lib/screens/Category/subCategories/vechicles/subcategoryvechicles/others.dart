...
class OthersVechiles extends StatefulWidget {
  const OthersVechiles({Key? key}) : super(key: key);

  @override
  State<OthersVechiles> createState() => _OthersVechilesState();
}

class _OthersVechilesState extends State<OthersVechiles> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectVachile", isEqualTo: "Others").snapshots().listen((event) {
