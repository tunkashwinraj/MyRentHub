...
class OtherInstruments extends StatefulWidget {
  const OtherInstruments({Key? key}) : super(key: key);

  @override
  State<OtherInstruments> createState() => _OtherInstrumentsState();
}

class _OtherInstrumentsState extends State<OtherInstruments> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectMusicalInstruments", isEqualTo: "Other Instruments").snapshots().listen((event) {
