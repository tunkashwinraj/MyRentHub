...
class Keyboards extends StatefulWidget {
  ...
  @override
  State<Keyboards> createState() => _KeyboardsState();
}

class _KeyboardsState extends State<Keyboards> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectMusicalInstruments", isEqualTo: "Keyboards").snapshots().listen((event) {
