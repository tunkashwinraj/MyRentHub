...
class DJEquipment extends StatefulWidget {
  const DJEquipment({Key? key}) : super(key: key);

  @override
  State<DJEquipment> createState() => _DJEquipmentState();
}

class _DJEquipmentState extends State<DJEquipment> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectMusicalInstruments", isEqualTo: "DJ Equipment").snapshots().listen((event) {
