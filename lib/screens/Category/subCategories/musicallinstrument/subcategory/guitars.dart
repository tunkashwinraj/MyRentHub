...
class Guitars extends StatefulWidget {
  const Guitars({Key? key}) : super(key: key);

  @override
  State<Guitars> createState() => _GuitarsState();
}

class _GuitarsState extends State<Guitars> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectMusicalInstruments", isEqualTo: "Guitars").snapshots().listen((event) {
