...
class Violins extends StatefulWidget {
  const Violins({Key? key}) : super(key: key);

  @override
  State<Violins> createState() => _ViolinsState();
}

class _ViolinsState extends State<Violins> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectToolsEquipment", isEqualTo: "Violins").snapshots().listen((event) {
