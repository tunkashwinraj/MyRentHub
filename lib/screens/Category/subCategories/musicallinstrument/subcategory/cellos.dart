...
class Cellos extends StatefulWidget {
  const Cellos({Key? key}) : super(key: key);

  @override
  State<Cellos> createState() => _CellosState();
}

class _CellosState extends State<Cellos> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectMusicalInstruments", isEqualTo: "Cellos").snapshots().listen((event) {
