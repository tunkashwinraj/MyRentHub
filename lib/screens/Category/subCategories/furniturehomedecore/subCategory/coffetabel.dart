...
class CoffeTabel extends StatefulWidget {
  const CoffeTabel({Key? key}) : super(key: key);

  @override
  State<CoffeTabel> createState() => _CoffeTabelState();
}

class _CoffeTabelState extends State<CoffeTabel> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHomeFurniture", isEqualTo: "Coffe Tabel").snapshots().listen((event) {
