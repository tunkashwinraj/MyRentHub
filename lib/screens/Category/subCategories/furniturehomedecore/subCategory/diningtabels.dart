...
class DiningTabels extends StatefulWidget {
  const DiningTabels({Key? key}) : super(key: key);

  @override
  State<DiningTabels> createState() => _DiningTabelsState();
}

class _DiningTabelsState extends State<DiningTabels> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHomeFurniture", isEqualTo: "Dining Tabels").snapshots().listen((event) {
