...
import '../../../../detailScreen/detailscreen.dart';class OtherFurntinure extends StatefulWidget {
  const OtherFurntinure({Key? key}) : super(key: key);

  @override
  State<OtherFurntinure> createState() => _OtherFurntinureState();
}

class _OtherFurntinureState extends State<OtherFurntinure> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHomeFurniture", isEqualTo: "Other Furntinure").snapshots().listen((event) {
