...
class Matteres extends StatefulWidget {
  const Matteres({Key? key}) : super(key: key);

  @override
  State<Matteres> createState() => _MatteresState();
}

class _MatteresState extends State<Matteres> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHomeFurniture", isEqualTo: "Matteres").snapshots().listen((event) {
