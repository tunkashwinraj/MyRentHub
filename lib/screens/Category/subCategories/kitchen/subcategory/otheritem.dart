...
class Otheritem extends StatefulWidget {
  const Otheritem({Key? key}) : super(key: key);

  @override
  State<Otheritem> createState() => _OtheritemState();
}
...
class _OtheritemState extends State<Otheritem> {
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectKitchenAppliences", isEqualTo: "Other item").snapshots().listen((event) {
