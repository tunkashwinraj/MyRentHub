...
class CoffeMachines extends StatefulWidget {
  const CoffeMachines({Key? key}) : super(key: key);

  @override
  State<CoffeMachines> createState() => _CoffeMachinesState();
}

class _CoffeMachinesState extends State<CoffeMachines> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      ...
      FirebaseFirestore.instance.collection("Categories").where(
          "selectKitchenAppliences", isEqualTo: "Coffe MAchines").snapshots().listen((
          event) {
        data.clear();
        setState(() {});
                        ...
                        child: Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Icon(
                                  Icons.add, color: Colors.white, size: 14),
                            ),
                          ],
                        ),
                      ),
