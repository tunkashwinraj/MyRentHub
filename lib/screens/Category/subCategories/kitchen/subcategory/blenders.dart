...
class Blenders extends StatefulWidget {
  const Blenders({Key? key}) : super(key: key);

  @override
  State<Blenders> createState() => _BlendersState();
}

class _BlendersState extends State<Blenders> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectKitchenAppliences", isEqualTo: "Blenders").snapshots().listen((event) {
