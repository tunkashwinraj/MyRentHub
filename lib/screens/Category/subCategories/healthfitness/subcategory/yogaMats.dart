...
class YogaMats extends StatefulWidget {
  const YogaMats({Key? key}) : super(key: key);

  @override
  State<YogaMats> createState() => _YogaMatsState();
}

class _YogaMatsState extends State<YogaMats> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHeathFitness", isEqualTo: "YogaMats").snapshots().listen((event) {
