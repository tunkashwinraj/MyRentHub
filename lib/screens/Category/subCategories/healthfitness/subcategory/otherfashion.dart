...
class OtherFashionGear extends StatefulWidget {
  const OtherFashionGear({Key? key}) : super(key: key);

  @override
  State<OtherFashionGear> createState() => _OtherFashionGearState();
}

class _OtherFashionGearState extends State<OtherFashionGear> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHeathFitness", isEqualTo: "Other Fashion Gear").snapshots().listen((event) {
