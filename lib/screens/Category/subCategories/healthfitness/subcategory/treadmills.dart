...
class Treadmills extends StatefulWidget {
  const Treadmills({Key? key}) : super(key: key);

  @override
  State<Treadmills> createState() => _TreadmillsState();
}

class _TreadmillsState extends State<Treadmills> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHeathFitness", isEqualTo: "Treadmills").snapshots().listen((event) {
