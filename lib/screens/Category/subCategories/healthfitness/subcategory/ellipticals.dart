...
class Ellipticals extends StatefulWidget {
  const Ellipticals({Key? key}) : super(key: key);

  @override
  State<Ellipticals> createState() => _EllipticalsState();
}

class _EllipticalsState extends State<Ellipticals> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHeathFitness", isEqualTo: "Ellipticals").snapshots().listen((event) {
