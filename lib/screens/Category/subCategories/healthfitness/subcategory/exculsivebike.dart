...
class ExculsiveBike extends StatefulWidget {
  const ExculsiveBike({Key? key}) : super(key: key);

  @override
  State<ExculsiveBike> createState() => _ExculsiveBikeState();
}

class _ExculsiveBikeState extends State<ExculsiveBike> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHeathFitness", isEqualTo: "Exercise Bike").snapshots().listen((event) {
