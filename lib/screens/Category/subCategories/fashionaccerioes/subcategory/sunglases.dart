...
class Sunglases extends StatefulWidget {
  const Sunglases({Key? key}) : super(key: key);

  @override
  State<Sunglases> createState() => _SunglasesState();
}

class _SunglasesState extends State<Sunglases> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectFashionAccerioes", isEqualTo: "Sunglases").snapshots().listen((event) {
