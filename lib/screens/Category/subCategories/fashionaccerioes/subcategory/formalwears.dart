...
class FormalWears extends StatefulWidget {
  const FormalWears({Key? key}) : super(key: key);

  @override
  State<FormalWears> createState() => _FormalWearsState();
}

class _FormalWearsState extends State<FormalWears> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectFashionAccerioes", isEqualTo: "Formal Wears").snapshots().listen((event) {
