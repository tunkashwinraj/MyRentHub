...
class OthersFashionAcc extends StatefulWidget {
  const OthersFashionAcc({Key? key}) : super(key: key);

  @override
  State<OthersFashionAcc> createState() => _OthersFashionAccState();
}

class _OthersFashionAccState extends State<OthersFashionAcc> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectFashionAccerioes", isEqualTo: "Others FashionAcc").snapshots().listen((event) {
