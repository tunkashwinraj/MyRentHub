...
class ExculiseMens extends StatefulWidget {
  const ExculiseMens({Key? key}) : super(key: key);

  @override
  State<ExculiseMens> createState() => _ExculiseMensState();
}

class _ExculiseMensState extends State<ExculiseMens> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectFashionAccerioes", isEqualTo: "Exculise Mens").snapshots().listen((event) {
