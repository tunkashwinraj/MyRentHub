...
class Jawellery extends StatefulWidget {
  const Jawellery({Key? key}) : super(key: key);

  @override
  State<Jawellery> createState() => _JawelleryState();
}

class _JawelleryState extends State<Jawellery> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectFashionAccerioes", isEqualTo: "Jawellery").snapshots().listen((event) {
