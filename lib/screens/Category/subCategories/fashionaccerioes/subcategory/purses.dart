...
class Purses extends StatefulWidget {
  const Purses({Key? key}) : super(key: key);

  @override
  State<Purses> createState() => _PursesState();
}

class _PursesState extends State<Purses> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectFashionAccerioes", isEqualTo: "Purses").snapshots().listen((event) {
