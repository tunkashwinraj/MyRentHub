...
class BabyMonitors extends StatefulWidget {
  const BabyMonitors({Key? key}) : super(key: key);

  @override
  State<BabyMonitors> createState() => _BabyMonitorsState();
}

class _BabyMonitorsState extends State<BabyMonitors> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectBabyKidsGear", isEqualTo: "Baby Monitors").snapshots().listen((event) {
