...
class OthersKidsGear extends StatefulWidget {
  const OthersKidsGear({Key? key}) : super(key: key);

  @override
  State<OthersKidsGear> createState() => _OthersKidsGearState();
}

class _OthersKidsGearState extends State<OthersKidsGear> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectBabyKidsGear", isEqualTo: "Others Kids Gear").snapshots().listen((event) {
