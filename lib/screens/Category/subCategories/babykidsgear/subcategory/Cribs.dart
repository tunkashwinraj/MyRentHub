...
class Cribs extends StatefulWidget {
  const Cribs({Key? key}) : super(key: key);

  @override
  State<Cribs> createState() => _CribsState();
}

class _CribsState extends State<Cribs> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectBabyKidsGear", isEqualTo: "Cribs").snapshots().listen((event) {
