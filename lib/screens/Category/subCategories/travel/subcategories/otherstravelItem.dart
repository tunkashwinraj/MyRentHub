...
class OthersTravelItem extends StatefulWidget {
  const OthersTravelItem({Key? key}) : super(key: key);

  @override
  State<OthersTravelItem> createState() => _OthersTravelItemState();
}

class _OthersTravelItemState extends State<OthersTravelItem> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectTravelLuggage", isEqualTo: "Others TravelItem").snapshots().listen((event) {
