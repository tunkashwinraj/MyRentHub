...
class Suitcases extends StatefulWidget {
  const Suitcases({Key? key}) : super(key: key);

  @override
  State<Suitcases> createState() => _SuitcasesState();
}

class _SuitcasesState extends State<Suitcases> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectTravelLuggage", isEqualTo: "Suitcases").snapshots().listen((event) {
