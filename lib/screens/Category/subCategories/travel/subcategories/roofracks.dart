...
class RoofRacks extends StatefulWidget {
  const RoofRacks({Key? key}) : super(key: key);

  @override
  State<RoofRacks> createState() => _RoofRacksState();
}

class _RoofRacksState extends State<RoofRacks> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectTravelLuggage", isEqualTo: "Roof Racks").snapshots().listen((event) {
