...
class TravelAccerioes extends StatefulWidget {
  const TravelAccerioes({Key? key}) : super(key: key);

  @override
  State<TravelAccerioes> createState() => _TravelAccerioesState();
}

class _TravelAccerioesState extends State<TravelAccerioes> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectTravelLuggage", isEqualTo: "Travel Accerioes").snapshots().listen((event) {
