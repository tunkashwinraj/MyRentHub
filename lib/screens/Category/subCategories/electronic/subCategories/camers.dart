...
class Camers extends StatefulWidget {
  const Camers({Key? key}) : super(key: key);

  @override
  State<Camers> createState() => _CamersState();
}

class _CamersState extends State<Camers> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectElectronics", isEqualTo: "Cameras").snapshots().listen((event) {
