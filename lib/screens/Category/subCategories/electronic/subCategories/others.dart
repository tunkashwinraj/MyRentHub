...
class OthersElectronic extends StatefulWidget {
  const OthersElectronic({Key? key}) : super(key: key);

  @override
  State<OthersElectronic> createState() => _OthersElectronicState();
}

class _OthersElectronicState extends State<OthersElectronic> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectElectronics", isEqualTo: "OtherElectronic").snapshots().listen((event) {
