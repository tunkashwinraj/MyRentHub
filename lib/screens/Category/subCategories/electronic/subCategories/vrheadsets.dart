...
class VrHeadsets extends StatefulWidget {
  const VrHeadsets({Key? key}) : super(key: key);

  @override
  State<VrHeadsets> createState() => _VrHeadsetsState();
}

class _VrHeadsetsState extends State<VrHeadsets> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectElectronics", isEqualTo: "VRHeadset").snapshots().listen((event) {
