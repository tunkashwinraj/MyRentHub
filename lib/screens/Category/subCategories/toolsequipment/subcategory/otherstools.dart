...
import '../../../../detailScreen/detailscreen.dart';class OthersTools extends StatefulWidget {
  const OthersTools({Key? key}) : super(key: key);

  @override
  State<OthersTools> createState() => _OthersToolsState();
}

class _OthersToolsState extends State<OthersTools> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectToolsEquipment", isEqualTo: "Others Tools").snapshots().listen((event) {
