...
class PaintingEquipment extends StatefulWidget {
  const PaintingEquipment({Key? key}) : super(key: key);

  @override
  State<PaintingEquipment> createState() => _PaintingEquipmentState();
}

class _PaintingEquipmentState extends State<PaintingEquipment> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectToolsEquipment", isEqualTo: "Painting Equipment").snapshots().listen((event) {
