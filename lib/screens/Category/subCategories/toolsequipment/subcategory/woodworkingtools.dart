...
class WoodWorkingTools extends StatefulWidget {
  const WoodWorkingTools({Key? key}) : super(key: key);

  @override
  State<WoodWorkingTools> createState() => _WoodWorkingToolsState();
}

class _WoodWorkingToolsState extends State<WoodWorkingTools> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectToolsEquipment", isEqualTo: "Wood Working Tools").snapshots().listen((event) {
