...
class Shredders extends StatefulWidget {
  const Shredders({Key? key}) : super(key: key);

  @override
  State<Shredders> createState() => _ShreddersState();
}

class _ShreddersState extends State<Shredders> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectOfficeEquipment", isEqualTo: "Shredders").snapshots().listen((event) {
