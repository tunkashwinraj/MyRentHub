...
class FishingEquipment extends StatefulWidget {
  const FishingEquipment({Key? key}) : super(key: key);

  @override
  State<FishingEquipment> createState() => _FishingEquipmentState();
}

class _FishingEquipmentState extends State<FishingEquipment> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectSportsEquipment", isEqualTo: "Fishing Equipment").snapshots().listen((event) {
