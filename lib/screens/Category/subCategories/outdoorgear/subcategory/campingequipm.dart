...
class CampingEquipm extends StatefulWidget {
  const CampingEquipm({Key? key}) : super(key: key);

  @override
  State<CampingEquipm> createState() => _CampingEquipmState();
}

class _CampingEquipmState extends State<CampingEquipm> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectSportsEquipment", isEqualTo: "CampingEquipm").snapshots().listen((event) {
