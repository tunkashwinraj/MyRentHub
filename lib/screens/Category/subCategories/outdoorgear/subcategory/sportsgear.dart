...
class SportsGear extends StatefulWidget {
  const SportsGear({Key? key}) : super(key: key);

  @override
  State<SportsGear> createState() => _SportsGearState();
}

class _SportsGearState extends State<SportsGear> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectSportsEquipment", isEqualTo: "SportsGear").snapshots().listen((event) {
