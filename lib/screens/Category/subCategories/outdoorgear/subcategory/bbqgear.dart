...
class BBQGear extends StatefulWidget {
  const BBQGear({Key? key}) : super(key: key);

  @override
  State<BBQGear> createState() => _BBQGearState();
}

class _BBQGearState extends State<BBQGear> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectSportsEquipment", isEqualTo: "BBQ Gear").snapshots().listen((event) {
