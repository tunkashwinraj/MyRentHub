...
class OthersTools extends StatefulWidget {
...
class _OthersToolsState extends State<OthersTools> {
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectSportsEquipment", isEqualTo: "Others Tools").snapshots().listen((event) {
