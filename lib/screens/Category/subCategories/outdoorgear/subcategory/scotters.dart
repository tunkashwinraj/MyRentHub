...
class Scotters extends StatefulWidget {
  const Scotters({Key? key}) : super(key: key);

  @override
  State<Scotters> createState() => _ScottersState();
}

class _ScottersState extends State<Scotters> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectSportsEquipment", isEqualTo: "Scotters").snapshots().listen((event) {
