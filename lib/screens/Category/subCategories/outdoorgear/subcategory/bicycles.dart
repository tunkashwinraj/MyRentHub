...
class Bicycles extends StatefulWidget {
  const Bicycles({Key? key}) : super(key: key);
...
class _BicyclesState extends State<Bicycles> {
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectSportsEquipment", isEqualTo: "Bicycles").snapshots().listen((event) {
