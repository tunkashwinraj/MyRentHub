...
import 'package:myrenthub/screens/detailScreen/detailscreen.dart';
...
class _ApartmentsState extends State<Apartments> {
  ...
  List<bool> isFavoriteList =
      []; // List to track favorite status for each product
    ...
    try {
      final QuerySnapshot<Map<String, dynamic>> querySnapshot =
          await FirebaseFirestore.instance
              ...
              .where("selectedRealEstateOption", isEqualTo: "apartment")
              .get();
      ...
      // Initialize isFavoriteList with false for each product
