...
class PartyTents extends StatefulWidget {
  const PartyTents({Key? key}) : super(key: key);

  @override
  State<PartyTents> createState() => _PartyTentsState();
}

class _PartyTentsState extends State<PartyTents> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectPartyEventSupplies", isEqualTo: "Party Tents").snapshots().listen((event) {
