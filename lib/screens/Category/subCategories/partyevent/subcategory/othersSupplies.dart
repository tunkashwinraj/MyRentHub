...
class OthersSupplies extends StatefulWidget {
  const OthersSupplies({Key? key}) : super(key: key);

  @override
  State<OthersSupplies> createState() => _OthersSuppliesState();
}

class _OthersSuppliesState extends State<OthersSupplies> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectPartyEventSupplies", isEqualTo: "Others Supplies").snapshots().listen((event) {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        onTap: (){
                        //  Get.to(() => AddToCart(dataList: data));
                        },
                        child: Row(
                          children: [
                            Text(
