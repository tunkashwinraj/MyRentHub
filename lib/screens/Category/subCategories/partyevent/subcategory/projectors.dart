...
class Projectors extends StatefulWidget {
  const Projectors({Key? key}) : super(key: key);

  @override
  State<Projectors> createState() => _ProjectorsState();
}

class _ProjectorsState extends State<Projectors> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectPartyEventSupplies", isEqualTo: "Projectors").snapshots().listen((event) {
