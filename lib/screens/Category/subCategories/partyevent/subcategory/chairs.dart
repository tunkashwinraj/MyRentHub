...
class ChairsParty extends StatefulWidget {
  const ChairsParty({Key? key}) : super(key: key);

  @override
  State<ChairsParty> createState() => _ChairsPartyState();
}

class _ChairsPartyState extends State<ChairsParty> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectPartyEventSupplies", isEqualTo: "Chairs").snapshots().listen((event) {
