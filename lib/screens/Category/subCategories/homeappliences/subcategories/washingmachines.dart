...
class WashingMachines extends StatefulWidget {
  const WashingMachines({Key? key}) : super(key: key);

  @override
  State<WashingMachines> createState() => _WashingMachinesState();
}

class _WashingMachinesState extends State<WashingMachines> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHomeAppliences", isEqualTo: "Washing Machines").snapshots().listen((event) {
