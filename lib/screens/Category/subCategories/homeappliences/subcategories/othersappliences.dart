...
class OthersAppliences extends StatefulWidget {
  const OthersAppliences({Key? key}) : super(key: key);

  @override
  State<OthersAppliences> createState() => _OthersAppliencesState();
}

class _OthersAppliencesState extends State<OthersAppliences> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHomeAppliences", isEqualTo: "Others Appliences").snapshots().listen((event) {
