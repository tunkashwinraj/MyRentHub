...
class Microwaves extends StatefulWidget {
  const Microwaves({Key? key}) : super(key: key);

  @override
  State<Microwaves> createState() => _MicrowavesState();
}

class _MicrowavesState extends State<Microwaves> {
  List<DataModel> data = [];
  ...
  getData() {
    try {
      data.clear();
      setState(() {});
      FirebaseFirestore.instance.collection("Categories").where("selectHomeAppliences", isEqualTo: "Microwaves").snapshots().listen((event) {
